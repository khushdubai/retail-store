...
import com.shopping.discount.item.PromotionPrice;
...
public class Cart {
    ...
    public Cart(User user, DiscountHandler discountPolicy) 
    {
        quantities = new LinkedHashMap<Item, Integer>();
        this.user = user;
